...
void passwdEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (passwdEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&passwdEdit::passwdEditOk)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject passwdEdit::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_passwdEdit.data,
